# Task-o-Time: maintainable desktop delivery (S0)
...
Your starting point is **S0: the original mixed .NET Framework application with production VB**. Normalize application and test projects to net472, convert production VB to C#, then establish SDK-style net472 before targeting .NET 10. The quality and workflow requirements below also remain.
