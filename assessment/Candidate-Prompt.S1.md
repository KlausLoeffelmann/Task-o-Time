# Task-o-Time: maintainable desktop delivery (S1)
...
Your starting point is **S1: net472 with production VB**. Framework normalization is already complete. Convert production VB to C#, then establish SDK-style net472 before targeting .NET 10. The quality and workflow requirements below also remain.
