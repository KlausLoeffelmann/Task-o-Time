# Task-o-Time candidate starting point (S1)

This branch is the **S1** starting point: the application and test projects
target .NET Framework 4.7.2, and production code still contains C# and Visual
Basic. Read [Candidate-Prompt.md](Candidate-Prompt.md) before changing the
solution; it defines the requested outcome and the boundaries of the exercise.

## Prerequisites

- Windows with PowerShell.
- A current .NET SDK capable of restoring and building the solution. The
  .NET Framework 4.7.2 reference assemblies are restored as NuGet packages.
