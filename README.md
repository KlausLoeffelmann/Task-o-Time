# Task-o-Time candidate starting point (S2a)

This branch is the **S2a** starting point: production code is C#, all production
projects are SDK-style, and the application and tests still target .NET
Framework 4.7.2. Visual Basic remains only in candidate-visible tests. Read
[Candidate-Prompt.md](Candidate-Prompt.md) before changing the solution; it
defines the requested outcome and exercise boundaries.
