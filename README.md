# Task-o-Time candidate starting point (S2)

This branch is the **S2** starting point: the application and test projects
target .NET Framework 4.7.2, production code is C#, and Visual Basic remains
only in candidate-visible tests. Read
