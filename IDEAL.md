...
This branch is the ideal result for `candidate-csharp-sdkstyle-net472`. It
starts at that candidate's exact tip and overlays the completed common
application plus the canonical grader from `TheGoldenBranch` commit `9689f33`.
